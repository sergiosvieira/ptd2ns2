...
public:
	...
	UniformRandomVariable* create(int, const char* const *) {
...
public:
	...
	ExponentialRandomVariable* create(int, const char* const *) {
...
/*
 ...
 (k-1)!*lambda^k
 */
static class ErlangRandomVariableClass {
public:
	ErlangRandomVariableClass() {
	}
	ErlangRandomVariable* create(int, const char* const *) {
 ...
 */
static class GammaRandomVariableClass {
public:
	GammaRandomVariableClass() {
	}
	GammaRandomVariable* create(int, const char* const *) {
...
double GammaRandomVariable::value() {
	...
	if (alpha_ < 1) {
		...
		return GammaRandomVariable(1.0 + alpha_, beta_).value() * pow(u,
				1.0 / alpha_);
	}
...
public:
	...
	ParetoRandomVariable* create(int, const char* const *) {
...
public:
	...
	ParetoIIRandomVariable* create(int, const char* const *) {
...
public:
	...
	NormalRandomVariable* create(int, const char* const *) {
...
public:
	...
	LogNormalRandomVariable* create(int, const char* const *) {
...
public:
	...
	ConstantRandomVariable* create(int, const char* const *) {
...
public:
	...
	HyperExponentialRandomVariable* create(int, const char* const *) {
...
HyperExponentialRandomVariable::HyperExponentialRandomVariable(double avg,
		double cov) {
	alpha_ = .95;
	avg_ = avg;
	cov_ = cov;
...
static class WeibullRandomVariableClass {
public:
	WeibullRandomVariableClass() {
	}
	WeibullRandomVariable* create(int argc, const char* const * argv) {
		if (argc == 6) {
